...
export const keyedItems = [
  ...
  {
    dimension: 'problem_definition',
    situation: '"앱이 느리다"는 리뷰가 늘었다. 개발팀은 서버 증설을 제안한다.',
    question: '증설을 결정하기 전에 필요한 것은?',
    options: [
  ...
  },
  {
    ...
    correct: 0,
    principle: '지표 하나로 성공을 선언하면, 늘어난 불편은 다음 분기에 이탈로 돌아온다.'
  },
  {
    dimension: 'customer_impact',
    situation: '이용자 한 명이 막힌 지점을 아주 구체적으로 설명해 왔다. 같은 문의는 아직 없다.',
    question: '어떻게 다루는 것이 맞는가?',
    options: [
  ...
  },
  {
    ...
    options: [
      '하루치가 요일이나 유입 경로에 치우치지 않았는지, 차이가 우연으로도 나올 크기인지 본다.',
